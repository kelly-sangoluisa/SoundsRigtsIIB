      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-gray-600 dark:text-gray-400 mt-1">
            Comunícate con {user?.role === 'artist' ? 'compradores' : 'artistas'} sobre licencias musicales
          </p>
        </div>
          ...
          <div className="flex items-center">
            ...
            <div className="ml-3">
              <p className="text-sm text-red-800 dark:text-red-200">
                ...
                {' '}• Haz clic en un chat para ver los mensajes pendientes.
              </p>
            </div>
          </div>
        </div>
      ...
      {user && (
        <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
          ...
          <p className="text-sm text-blue-700 dark:text-blue-300 mt-1">
            {user.role === 'artist' 
              ? 'Puedes comunicarte con compradores de tus licencias para brindar soporte y crear vínculos.'
